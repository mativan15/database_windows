...
void pantalla_start(Producto array_libros_has[], Producto array_libros_viv[], Pedido Pedido1, Listas lista){
	bool r= true;
	system("cls");
...
void menu(Producto array_libros_has[], Producto array_libros_viv[], char usuario[64], Pedido Pedido1, Listas lista){
	bool repite = true;
	int opcion;
...
void catalogo(Producto array_libros_has[], Producto array_libros_viv[], Pedido Pedido1, Listas lista){
	bool retro =true;
	int op;
	system("cls");
	cout<<"\n\tCatalogo\n";
