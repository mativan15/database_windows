...
public:
    ...
    Pedido(const Pedido& other) {
        nombreCole = other.nombreCole;
        direccionCole = other.direccionCole;
        emailCole = other.emailCole;
        nombreResp = other.nombreResp;
        numTele = other.numTele;
        codigoCole = other.codigoCole;
        codigoRUC = other.codigoRUC;
    }
    void print_pedido() {
        cout << "Resumen Pedido: \n\n"
