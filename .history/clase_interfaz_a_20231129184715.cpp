...
InterfazAdmin::InterfazAdmin(Catalogo& catalogo1, Pedido& pedido, Listas& listaHas, Listas& listaViv, Usuario& usuario)
    : InterfazV(catalogo1, pedido, listaHas, listaViv, usuario) {
