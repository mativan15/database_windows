...
class InterfazV {
public:
    void menu( Pedido Pedido1, Listas lista_has, Listas lista_viv, Usuario usuario1)	{
		bool repite = true;
		int opcion;
			...
			if (cin.fail() || (opcion != 1 && opcion != 2 && opcion != 3 && opcion != 4)) { //comprabacion de erroes
				...
				switch (opcion){
					case 1:
						system("cls");
						//if
						catalogo(Pedido1, lista_has, lista_viv, usuario1);
						repite = false;
						break;
	...
	void catalogo(Pedido Pedido1, Listas lista_has, Listas lista_viv, Usuario usuario1){
		bool retro =true;
		int op;
		//system("cls");
		cout<<"\n\tCatalogo\n";
