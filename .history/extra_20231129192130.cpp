...
void pantalla_start(Listas& lista_has, Listas& lista_viv, Usuario& usuario1){
	bool r = true;
	system("cls");
		...
		if ((usuario!="") && (contrasena!="") ){
            Pedido Pedido1;
			Catalogo catalogo1(Pedido1, lista_has, lista_viv, usuario1);
			if (usuario1.contrasena[0] == 'a') {
				InterfazAdmin admin1(catalogo1, Pedido1, lista_has, lista_viv, usuario1);
				system("cls");
				admin1.menu();
			} else {
				
				InterfazV vendedor1(catalogo1, Pedido1, lista_has, lista_viv, usuario1);
				system("cls");
				vendedor1.menu();
			}
		}
