...
void instanciar_muestras(Producto array_libros[]){
	array_libros[0] = Producto("Libro Mat 'Crecemos Juntos'", "descripcion 1", "primaria", "8°grado", "matematica", 20, 120, 20112);
    array_libros[1] = Producto("Libro Com 'Crecemos Juntos'", "descripcion 2", "primaria", "2°grado", "comunicacion", 21, 122, 20112);
    array_libros[2] = Producto("Libro CS 'Aprende'", "descripcion 3", "secundaria", "4°grado", "ciencias sociales", 23, 128, 2017);
    array_libros[3] = Producto("Libro Personal Social 'Crecemos Juntos'", "descripcion 4", "primaria", "1°grado", "personal", 112, 129, 2019);
}

void print_tabla_libros(Producto array_libros[]){
	cout << left << setw(20) << "Nombre" << left << setw(15) << "descripcion" << left << setw(12) << "Nivel" << left << setw(12) << "Grado" << left << setw(12) << "Area" << left << setw(12) << "ISBN" << left << setw(12) << "Price" << left << setw(8) << "Stock\n";
		//left << setw(12) << "Marks" << left  << setw(8) << "Year\n";
    for (int i = 0; i < 4; i++){
        cout << left << setw(20) << array_libros[i].nombreLibro
            << left << setw(15) << array_libros[i].descripcionLib 
