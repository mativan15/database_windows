...
void Pedido::set_lista_venta(Listas productos_anadidos){
    ...
    for (int i = 0; i < productos_anadidos.get_tamano_lista(); i++){
        ...
        cout << left << setw(20) << temp_producto.getNombreLibro() << setw(10) << temp_producto.get_cantidad() << setw(15) << temp_producto.getPrecio() << setw(15) << temp_producto.get_subtotal() << endl;
