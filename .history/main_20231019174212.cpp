...
void print_tabla_libros(Producto array_libros[]){
	cout << left << setw(10) << "Nombre" << left << setw(8) << "descripcion" << left << setw(12) << "Nivel" << left << setw(12) << "Grado" << left << setw(12) << "Area" << left << setw(12) << "ISBN" << left << setw(12) << "Price" << left << setw(8) << "Stock\n";
