...
void Pedido::tab_pedido() {
	...
	do{
		...
		if (cin.fail() || !(op >= 1 && op <=4)){
            ...
            limpiar_archivo("../src/Project_0013/data_ped.txt");
                ...
                do {
                    ...
                    if (cin.fail() || !(op >= 1 && op <= 3)) {
                        ...
                        case 3:
                            ...
                            limpiar_archivo("../src/Project_0013/data_array.txt");
...
void Pedido::set_lista_venta(Listas productos_anadidos){
    ...
    for (int i = 0; i < productos_anadidos.get_tamano_lista(); i++){
        ...
        cout << endl << left << setw(20) << cantidad << setw(10) << nombre << setw(15) << precio << setw(15) << endl;
