...
void Pedido::print_pedido() {
    cout << "\x1B[32m" << "\n\tResumen Pedido: \n\n"<< "\x1B[m"
         << "\x1B[88m" << "Nombre del Colegio: " << "\x1B[m"<< (nombreCole ? nombreCole : "N/A") << endl
         << "\x1B[88m" << "Codigo del Colegio: " << "\x1B[m"<< codigoCole << endl
         << "\x1B[88m" << "Direccion: " << "\x1B[m"<< (direccionCole ? direccionCole : "N/A") << endl
         << "\x1B[88m" << "Email: " << "\x1B[m"<< (emailCole ? emailCole : "N/A") << endl
         << "\x1B[88m" << "Nombre del Responsable: " << "\x1B[m"<< (nombreResp ? nombreResp : "N/A") << endl
         << "\x1B[88m" << "Numero de Telefono: " << "\x1B[m"<< numTele << endl
         << "\x1B[88m" << "Codigo de RUC: " << "\x1B[m"<< codigoRUC << endl;  
}
