...
void print_tabla_libros(Producto array_libros[]){
	cout << left << setw(20) << "Nombre" << left << setw(8) << "descripcion" << left << setw(12) << "Nivel" << left << setw(12) << "Grado" << left << setw(12) << "Area" << left << setw(12) << "ISBN" << left << setw(12) << "Price" << left << setw(8) << "Stock\n";
		//left << setw(12) << "Marks" << left  << setw(8) << "Year\n";
    for (int i = 0; i < 4; i++){
        cout << left << setw(20) << array_libros[i].nombreLibro
            << left << setw(8) << array_libros[i].descripcionLib 
