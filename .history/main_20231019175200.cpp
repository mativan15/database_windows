...
void instanciar_muestras(Producto array_libros[]){
    ...
    array_libros[2] = Producto("CS 'Aprende'", "descripcion 3", "secundaria", "4 grado", "ciencias s.", 23, 128, 2017);
    array_libros[3] = Producto("Personal Social 'Crecemos J'", "descripcion 4", "primaria", "1 grado", "personal", 112, 129, 2019);
}

void print_tabla_libros(Producto array_libros[]){
	system("cls");
	cout << left << setw(30) << "Nombre" << left << setw(25) << "descripcion" << left << setw(12) << "Nivel" << left << setw(12) << "Grado" << left << setw(12) << "Area" << left << setw(12) << "ISBN" << left << setw(12) << "Price" << left << setw(8) << "Stock" << endl;
